...
RUN git clone https://github.com/OHIF/Viewers.git --depth 1 -b master --single-branch
# RUN git clone https://github.com/OHIF/Viewers.git --depth 1 -b refactor/1387 --single-branch
# RUN git clone https://github.com/OsiriX-Foundation/Viewers.git --depth 1 -b reportprovider --single-branch
